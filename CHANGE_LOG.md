...
## [2026-05-15 14:55:00]
- **Type**: UI/UX (Interaction Upgrade)
- **Content**: 深度重构 AI 服务管理交互。1) 引入拖拽排序：增加 6 点式拖拽手柄，移除冗余的“上移/下移”按钮，大幅节省空间并符合直觉；2) 统一开关逻辑：将“设为默认”从普通按钮改为单选框样式的切换开关，与“启用”开关保持视觉一致；3) 布局精简：优化 Grid 列表配置，显著减少了列表项中的视觉干扰，界面更显高级感。
