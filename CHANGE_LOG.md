...
## [2026-05-14]
- **Time**: 2026-05-14 18:29:00 +0800
- **Type**: Refactor (Pure Mode Alignment & Persistence)
- **Content**: 进一步精修纯净模式：1) 调整搜索框为水平单行布局，并确保输入内容与 AI 按钮绝对垂直居中；2) 调小问候语字号，使视觉层级更符合极简美学；3) 搜索引擎标签列表改为常驻显示，不再因搜索激活而隐藏，并强化了选中状态的视觉高亮（常亮效果）。
