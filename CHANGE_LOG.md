...
## [2026-05-14]
- **Time**: 2026-05-14 18:47:00 +0800
- **Type**: Refactor (AI Button Minimalism)
- **Content**: 彻底移除纯净模式 AI 按钮中的文字描述，回归极简的“火花”单图标设计。1) 采用圆形透明容器，平时呈现低调的灰色（#999），悬浮时变换为 Claude 标志性的橘色（#D97757）；2) 优化图标物理尺寸（20px）与描边细度，使其在大型卡片右下角显得灵动且不抢占视觉中心。
